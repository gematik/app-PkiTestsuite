...
public class ModifyBackupUrlTslOperation implements TslOperation {

  private final String tslDownloadUrlBackup;

  public ModifyBackupUrlTslOperation(final String tslDownloadUrlBackup) {
    this.tslDownloadUrlBackup = tslDownloadUrlBackup;
  }
  ...
  public TslContainer apply(final TslContainer tslContainer) {
    ...
    TslModifier.modifyTslDownloadUrlBackup(tslUnsigned, tslDownloadUrlBackup);
