...
public class ModifyTslSeqNrTslOperation implements TslOperation {

  private final int tslSeqNr;

  ModifyTslSeqNrTslOperation(final int tslSeqNr) {
  ...
  public TslContainer apply(final TslContainer tslContainer) {
    ...
    TslModifier.modifySequenceNr(tslUnsigned, tslSeqNr);
