...
public class ModifyPrimaryUrlTslOperation implements TslOperation {

  private final String tslDownloadUrlPrimary;

  public ModifyPrimaryUrlTslOperation(final String tslDownloadUrlPrimary) {
    this.tslDownloadUrlPrimary = tslDownloadUrlPrimary;
  }
  ...
  public TslContainer apply(final TslContainer tslContainer) {
    ...
    TslModifier.modifyTslDownloadUrlPrimary(tslUnsigned, tslDownloadUrlPrimary);
